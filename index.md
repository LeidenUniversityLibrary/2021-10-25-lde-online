...
venue: "Universiteit Leiden, TU Delft and Erasmus University Rotterdam"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
latitude: "52.157547"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "4.481571"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "Oct 25, 26, 28, 29, 2021"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Esther Plomp", "Ben Companjen", "Peter Verhaar", "Kristina Hettne", "Eirini Zormpa", "Claudiu Forgaci"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Eirini Zormpa", "Ben Companjen", "Peter Verhaar", "Kristina Hettne", "Esther Plomp", "Eduard Klapwijk", "Clémentine Cottineau"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
eventbrite:  "178855841637"         # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
